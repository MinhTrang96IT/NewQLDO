...
namespace QuanLyDiaOc.GUI
{
    public partial class FormChiTietPhieuDangKy : Form
    {
        ...
        private void LoadGBPhieuDangKy()
        {
            ...
            lblTongTien.Text = rowPDK["TongTien"].ToString() + " VNĐ";
        }
        ...
        private void LoadGBDiaOc()
        {
            ...
            lblDTKV.Text = rowDO["DienTichKhuonVien"].ToString() + " m2";
            lblDTSD.Text = rowDO["DienTichSuDung"].ToString() + " m2";
            lblHuongNha.Text = rowDO["HuongNha"].ToString();
            lblChieuDaiNha.Text = rowDO["ChieuDaiDat"].ToString() + " m";
            lblChieuRongNha.Text = rowDO["ChieuRongDat"].ToString() + " m";
            lblChieuDaiDat.Text = rowDO["ChieuDaiNha"].ToString() + " m";
            lblChieuRongDat.Text = rowDO["ChieuRongNha"].ToString() + " m";
